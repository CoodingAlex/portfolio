  ...
  projects: [
    {
      ...
      url: 'https://octolion-coodingalex-4zdk6u2xm.vercel.app/products',
      img:
        'https://res.cloudinary.com/dcoxmw8gn/image/upload/v1593045606/Captura_de_pantalla_de_2020-06-24_18-39-49_zwyunb.png',
      tecnologies: ['express', 'pug', 'ssr']
    },
    {
      ...
      tecnologies: ['React', 'Socket.io', 'Node', 'Express']
    },
    {
    ...
    },
    {
      ...
      tecnologies: ['Express', 'ssr', 'Passport.js', 'Node', 'Handlebars']
    },
    {
      title: 'my blog',
      content:
      ...
      tecnologies: ['Express', 'ssr', 'React', 'Node']
    }
  ],
  about: {
    data:
